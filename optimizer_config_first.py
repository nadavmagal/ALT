...
GD_type_to_params_dic = {
    # OptimizerOptions.GD: [OptimizerHyperParams(OptimizerOptions.GD, 0.8)],
    # OptimizerOptions.ConstrainedGD: [OptimizerHyperParams(OptimizerOptions.ConstrainedGD, 0.1, k=1)],
    # OptimizerOptions.RegularizedGD: [OptimizerHyperParams(OptimizerOptions.RegularizedGD, 0.7, reg=0.035)],
    # OptimizerOptions.SGD: [OptimizerHyperParams(OptimizerOptions.SGD, 0.95)],
    OptimizerOptions.RegularizedGD_3: [OptimizerHyperParams(OptimizerOptions.RegularizedGD, 0.7, reg=0.04),
                                       OptimizerHyperParams(OptimizerOptions.RegularizedGD, 0.7, reg=0.05),
                                       OptimizerHyperParams(OptimizerOptions.RegularizedGD, 0.7, reg=0.02)]
}
