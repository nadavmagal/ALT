...
GD_type_to_params_dic = {
    ...
    # OptimizerOptions.RegularizedGD_3: [OptimizerHyperParams(OptimizerOptions.RegularizedGD, 0.25, reg=0.035),
    #                                    OptimizerHyperParams(OptimizerOptions.RegularizedGD, 0.3, reg=0.1),
